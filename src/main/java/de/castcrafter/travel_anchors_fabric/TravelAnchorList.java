package de.castcrafter.travel_anchors_fabric;

import de.castcrafter.travel_anchors.TravelAnchors;
import de.castcrafter.travel_anchors_fabric.network.Networking;
...
public class TravelAnchorList extends WorldSavedData {
    ...
    public static TravelAnchorList get(World world) {
        if (!world.isRemote) {
            ...
            return storage.getOrCreate(TravelAnchorList::new, de.castcrafter.travel_anchors.TravelAnchors.MODID);
        } else {
